...
def preprocess_image(image, target_size, rescale_factor):
...
file=st.file_uploader("반려견의 눈을 촬영해주세요.", type=['jpg', 'png', 'jpeg'])
...
if file is None:
    ...
    image=preprocess_image(image, target_size=(224, 224), rescale_factor=1./255)
    ...
    if predicted_label == 0:
        ...
        output_result = "백내장 증세가 있음"
    st.write(f"{output_result}")

    #절대경로, tensorflow 그 분의 version과 똑같이 맞춘다.
